...
def presc_analyze():
    ...
    user_prompt = "Give me the details about the Prescription and along with basic personal details only if it contains don't give any random personal details and tell about medications and frequency in a proper tabular form"
