def model():
    ...
    uploaded_file = st.file_uploader("Choose a pet image...", type=["jpg", "jpeg", "png", "webp","jfif","afif"])
    image = None
    ...
    if uploaded_file is not None:
        ...
        Who are you? : Your a expert veterinary doctor only in domesticated animals and you have the ability to do the below tasks with good accuracy.
        Text: Analyze the image and provide the following information:
        
        * Breed: Identify the breed of the animal in the image no matter what after breed indentification do give a disclaimer.
        * Disease Detection: If the image shows a diseased area, identify the specific disease and do give a disclaimer.
        Only if the disease is detected then tell about the Severity and Symptoms. 
        ...
        * Precautions: Recommend preventative measures to avoid the disease.
        ...
        st.warning("Disease and Breed will be identified only if the image contains the required information.")
        Disclaimer = (
