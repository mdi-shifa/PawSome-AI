...
#Uncomment if you want to add your own-custom pdf: ##Kepp this line commented forever
    ...
    # Display chat messages from history on app rerun    ##Kepp this line commented forever
